...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("--led-multiplexing", action="store",
                                 ...
                                 default=0, type=int)
        self.parser.add_argument("--red", help="The amount of red color for the RGB LED panel", default=51, type=int)
        self.parser.add_argument("--green", help="The amount of green color for the RGB LED panel", default=0, type=int)
        self.parser.add_argument("--blue", help="The amount of blue color for the RGB LED panel", default=111, type=int)
    ...
    def process(self):
        ...
        try:
            # Start loop
            print("Press CTRL-C to stop the Raspertise-Pi message scroller")
            self.run()
